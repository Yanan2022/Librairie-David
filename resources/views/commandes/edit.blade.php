            ...
            <div class=" main-content-area">
                ...
                <div class="wrap-address-billing">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="fname" type="text" name="prenoms" value="{{ $commande->prenoms }}"  />
                    </p>
                    <p class="row-in-form">
                        <label for="lname">Nom</label>
                        <input id="lname" type="text" name="nom" value="{{ $commande->nom }}"  />
                    </p>
                    {{-- <p class="row-in-form">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="phone" type="text" name="telephone" value="{{ $commande->telephone }}"
                            placeholder="Au format 10 chiffres" >
                    </p>
                    {{-- <p class="row-in-form">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="city" type="text" name="ville" value="{{ $commande->ville }}" >
                    </p>
                    <p class="row-in-form">
                        <label for="city2">Commune</label>
                        <input id="city2" type="text" name="commune" value="{{ $commande->commune }}"  />
                    </p>
                    <p class="row-in-form">
                        <label for="zip-code">Quartier</label>
                        <input id="zip-code" type="text" name="quartier" value="{{ $commande->quartier }}"  />
                    </p>
                </div>
