                ...
                <tbody>
                    @foreach ($bannieres as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bannieres.edit', $item->id) }}" class="btn btn-warning"><i
                                ...
                                <button class="btn btn-danger delete-row"
                                    data-uri="{{ route('bannieres.destroy', $item->id) }}"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="{{ route('bannieres.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
