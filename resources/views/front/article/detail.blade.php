        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Détail de l'article </span></li>
                </ul>
            </div>
                    ...
                    <ul class="products-cart">
                            <li class="pr-cart-item">
                                <div class="product-image">
                                    <figure>
                                        <img src="{{  asset('images/' . $article->ImageArticle) }}" alt="">
                                    </figure>
                                </div>
                                <div class="product-name">
                                    <a class="link-to-product"
                                        href="{{ route('panier.ajouter-article', $article->id) }}">{{  $article->LibelleArticle }}</a>
                                </div>
