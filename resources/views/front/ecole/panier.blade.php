        ...
        <div class="container">
            ...
            <div class=" main-content-area">
                ...
                <div class="wrap-iten-in-cart">
                    <h3 class="box-title">Les fournitures contenues dans le kit</h3>
                    <ul class="products-cart">
                        @foreach ($panier as $kit)
                            <li class="pr-cart-item">
                                <div class="product-image">
                                    <figure><img src="{{ asset('images/'.$kit->ImageArticle) }}" alt=""></figure>
                                </div>
                                <div class="product-name">
                                    <a class="link-to-product"
                                        href="{{-- route('articles.show', $article) --}}">{{ $kit->LibelleArticle }}
                                    </a>
                                </div>
                                <div class="price-field produtc-price">
                                    <p class="price">{{ $kit->PrixArticle }}  FCFA</p>
                                </div>
                                <div class="quantity">
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        <p class="summary-info"><span class="title">Sous-total</span><b
                                class="index">{{$prixTotal}} FCFA</b></p>
                    ...
                    <div class="checkout-info">
                        ...
                        <a class="btn btn-checkout" href="{{ route('kitcommande', $idKit) }}">Passer ma commande</a>
