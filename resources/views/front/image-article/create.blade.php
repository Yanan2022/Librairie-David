        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Commande spéciale</span></li>
                </ul>
            </div>
            <div class=" main-content-area">
                ...
                @endif
                <form action="{{ route('searchSpeciale') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="summary summary-checkout">
                        <div class="summary-item payment-method">
                            <h4 class="title-box">Entrez votre liste de fourniture<span>*</span></h4>
                            <p class="row-in-form">
                                <input id="coupon-code" type="file" name="image">
                            </p>
                        ...
                        <div class="summary-item shipping-method">
                            <h4 class="title-box f-title">Classe<span>*</span></h4>
                            <p class="row-in-form">
                                <input id="coupon-code" type="text" name="classe" placeholder="Classe">
                            </p>
                        </div>
                    </div>
                </form>
