            ...
            <div class=" main-content-area">
                                ...
                                <div class="quantity">
                                    <div class="quantity-input">
                                        <input type="text" name="product-quatity"
                                            value="{{ $article->pivot->quantite }}" data-max="120" pattern="[0-9]*" readonly>
                ...
                <div class="summary">
                    ...
                    <div class="checkout-info">
                        ...
                        <a class="btn btn-checkout" href="{{ route("commandes.create") }}">Soumettre ma commande</a>
                        <a class="link-to-shop" href="{{ url("/catal") }}">Continuer mes achats<i
