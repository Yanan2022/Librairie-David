                ...
                <tbody>
                    @foreach ($vehicule as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('Tvehicules.edit', $item->id) }}" class="btn btn-warning"><i
                                        class="la la-edit"></i></a>
                                <button class="btn btn-info"><i class="la la-search-plus"></i></button>
                                <button class="btn btn-danger delete-row"
                                    data-uri="{{ route('Tvehicules.destroy', $item->id) }}"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="{{ route('Tvehicules.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="largeInput">Désignation </label>
                            <input type="text" class="form-control form-control" id="LibelleType" name="LibelleType"
                                placeholder="Libelle Type">
                        </div>
